...
describe('Calcular el descuento en $ segun el peso volumetrico', ()=>{
    ...
    it('Se cobra un extra de 5 si el peso volumetrico esta entre 21-40', ()=>{
        const precioTotal = new PrecioTotal();
        precioTotal.cantidad = 12;
        precioTotal.precio = 365;
        precioTotal.estado = "UT";
        ...
        expect(precioTotal.calcularTotal()).toBe(4567.29);
    })

    it('Se cobra un extra de 6 si el peso volumetrico esta entre 41-80', ()=>{
        const precioTotal = new PrecioTotal();
        precioTotal.cantidad = 12;
        precioTotal.precio = 365;
        precioTotal.estado = "UT";
        ...
        expect(precioTotal.calcularTotal()).toBe(4568.24);
    })

    it('Se cobra un extra de 6.5 si el peso volumetrico esta entre 81-100', ()=>{
        const precioTotal = new PrecioTotal();
        precioTotal.cantidad = 12;
        precioTotal.precio = 365;
        precioTotal.estado = "UT";
        ...
        expect(precioTotal.calcularTotal()).toBe(4568.71);
    })

    it('Se cobra un extra de 8 si el peso volumetrico esta entre 101-200', ()=>{
        const precioTotal = new PrecioTotal();
        precioTotal.cantidad = 12;
        precioTotal.precio = 365;
        precioTotal.estado = "UT";
        precioTotal.categoria = "Muebles";
        precioTotal.peso = 150;
